...
local THEME_ACCENT = Color3.fromRGB(0, 220, 255)
local THEME_BG = Color3.fromRGB(5, 8, 14)
local THEME_PANEL = Color3.fromRGB(10, 14, 24)
local THEME_PANEL_ALT = Color3.fromRGB(15, 20, 34)
local THEME_PANEL_SOFT = Color3.fromRGB(20, 26, 42)
local THEME_BORDER = Color3.fromRGB(34, 52, 78)
local THEME_TEXT = Color3.fromRGB(235, 245, 255)
local THEME_TEXT_SOFT = Color3.fromRGB(155, 190, 220)
local THEME_INPUT = Color3.fromRGB(18, 25, 40)
...
function hoho:Window(hub, the_game_name, main_color)
	main_color = main_color or THEME_ACCENT
	local openned = true
	...
	Top_Bar.BackgroundColor3 = main_color
	...
	TrueGame.TextColor3 = THEME_TEXT
	...
	BlackBackground.BackgroundColor3 = THEME_BG
	...
	VideoBackground.BackgroundColor3 = THEME_BG
	...
	LeftTab.BackgroundColor3 = THEME_PANEL
	LeftTab.BackgroundTransparency = 0.500
	LeftTab.BorderColor3 = THEME_BORDER
	...
	GameName.Text = hub or "Mr.AsV HEHE HUB"
	GameName.TextColor3 = THEME_TEXT
	...
	RightTab.BackgroundColor3 = THEME_PANEL_ALT
	RightTab.BackgroundTransparency = 0.500
	RightTab.BorderColor3 = THEME_BORDER
	...
	FixBetter.BackgroundColor3 = main_color
	FixBetter.BackgroundTransparency = 0.200
	FixBetter.BorderColor3 = THEME_BORDER
	...
	SettingBt.ImageColor3 = THEME_TEXT
	...
	Minimize.ImageColor3 = THEME_TEXT
	...
	function hoho:Nof(txt,tine)
		spawn(function()
			...
			Nof2.Name = "Nof2"
			Nof2.Parent = Nof1
			Nof2.BackgroundColor3 = THEME_PANEL_ALT
			Nof2.BorderColor3 = THEME_BORDER
			...
			Nof3.Name = "Nof3"
			Nof3.Parent = Nof1
			Nof3.BackgroundColor3 = THEME_PANEL_SOFT
			...
			NofLabel.TextColor3 = THEME_TEXT
			...
			slidenof.BackgroundColor3 = main_color
			...
			Slide2.BackgroundColor3 = main_color
			Slide2.BorderColor3 = THEME_BORDER
	...
	function hoho_wind:Tab(tab_name)
		...
		TabFrame.ScrollBarImageColor3 = main_color
		...
		ClickHere.BackgroundColor3 = THEME_PANEL_SOFT
		...
		ClickHere.TextColor3 = THEME_TEXT
		...
		function hoho_tab:Line()
			...
			linetemp.BackgroundColor3 = main_color
		...
		function hoho_tab:Label(label_text, properties)
			...
			TextForm.BackgroundColor3 = THEME_PANEL_SOFT
			...
			TextHere.TextColor3 = THEME_TEXT
		...
		function hoho_tab:Toggle(toggle_text, state, func)
			...
			ToggleTemp.BackgroundColor3 = THEME_PANEL_SOFT
			...
			if toggled == true then
				ClickThis.BackgroundColor3 = main_color
			end
		...
		function hoho_tab:Slider(txt, min, max, mid, func)
			...
			SliderTemp.BackgroundColor3 = THEME_PANEL_SOFT
			...
			Slidenum.BackgroundColor3 = THEME_INPUT
			...
			Slidenum.TextColor3 = THEME_TEXT
			...
			Slide1.BackgroundColor3 = THEME_INPUT
			...
			HoldButton.BackgroundColor3 = THEME_TEXT
			...
			Slide.Name = "Slide"
			Slide.Parent = Slide1
			Slide.BackgroundColor3 = main_color
		...
		function hoho_tab:Dropdown(txt,list,func)
			...
			DropTemp.BackgroundColor3 = THEME_PANEL_SOFT
			DropTemp.BackgroundTransparency = 1.000
			DropTemp.BorderColor3 = THEME_BORDER
			...
			DropButton.BackgroundColor3 = THEME_PANEL_SOFT
			...
			DropButton.TextColor3 = THEME_TEXT
			...
			DropList.BackgroundColor3 = THEME_PANEL_ALT
			...
			DropList.ScrollBarImageColor3 = main_color

			
			local uistroke2 = Instance.new("UIStroke")
			uistroke2.Name = "stroke"
			uistroke2.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
			uistroke2.Color = THEME_BORDER
			...
			ButtonInsideDrop.BackgroundColor3 = THEME_PANEL_SOFT
			...
			ButtonInsideDrop.TextColor3 = THEME_TEXT
		...
		function hoho_tab:Textbox(txt,txt_hold,func)
			...
			TypeZone.BackgroundColor3 = THEME_PANEL_SOFT
			...
			Re.Name = "Re"
			Re.Parent = TypeZone
			Re.BackgroundColor3 = THEME_INPUT
			...
			Re.PlaceholderColor3 = THEME_TEXT_SOFT
			Re.PlaceholderText = txt_hold or "HoldTxt"
			Re.Text = ""
			Re.TextColor3 = THEME_TEXT
			Re.TextScaled = true
			Re.TextSize = 14.000
	...
	SettingFrame.BackgroundColor3 = THEME_PANEL_ALT
	SettingFrame.Position = UDim2.new(0.599137962, 0, 0.257080615, 0)
	SettingFrame.Size = UDim2.new(0, 241, 0, 258)
	SettingFrame.Visible = false
	local UIGradient = Instance.new("UIGradient")

	UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, THEME_PANEL), ColorSequenceKeypoint.new(1.00, THEME_PANEL_SOFT)}
	...
	GameNameZ.TextColor3 = THEME_TEXT
	...
	LamMo.BackgroundColor3 = THEME_BORDER
	...
	videoId.BackgroundColor3 = THEME_INPUT
	...
	videoId.PlaceholderColor3 = THEME_TEXT_SOFT
	videoId.PlaceholderText = "ID Video"
	videoId.Text = HoHo_Video_Id or ""
	videoId.TextColor3 = THEME_TEXT
	...
	ToggVideo.BackgroundColor3 = THEME_INPUT
	...
	ToggVideo.Text = ""
	ToggVideo.TextColor3 = THEME_TEXT
	ToggVideo.TextSize = 14.000
	if HoHo_Video_Display == "true" then
		ToggVideo.BackgroundColor3 = main_color
	end
	...
	VideoText.TextColor3 = THEME_TEXT
	...
	ToggleFastLoad.BackgroundColor3 = THEME_INPUT
	...
	ToggleFastLoad.Text = ""
	ToggleFastLoad.TextColor3 = THEME_TEXT
	ToggleFastLoad.TextSize = 14.000
	if HoHo_Tog_Fast == "true" then
		ToggleFastLoad.BackgroundColor3 = main_color
	end
	...
	FastLoadText.TextColor3 = THEME_TEXT
